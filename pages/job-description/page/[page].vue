      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="mx-auto mt-5 text-base font-normal leading-7 text-gray-600">
            Job Descriptions are a crucial part of any organization's
            documentation. They are used to communicate important information to
            employees, such as job responsibilities, qualifications, and
            expectations.
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <div class="mt-6 lg:mt-8">
                <a
                  :href="`/job-description/${resource.fields.slug}`"
...
const { data, error } = await useAsyncData("job-description", () =>
  client.getEntries({
...
const previousPageUrl = computed(() => {
  ...
  return currentPage.value === 2
    ? "/job-description"
    : `/job-description/page/${currentPage.value - 1}`;
});

const nextPageUrl = computed(() =>
  isLastPage.value ? "#" : `/job-description/page/${currentPage.value + 1}`
);
