      ...
      <div class="max-w-5xl mx-auto">
        ...
        >
          ...
          >
            <div class="overflow-hidden bg-gray-50 border border-gray-200 rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                ...
                >
                  <NuxtImg src="/images/logo.webp" alt="Company Logo" class="w-24 h-auto mb-4" provider="ipx" />
                  Request Demo
                </h4>
          ...
          >
            ...
            <p>
              Maecenas in pharetra hendrerit neque, tellus eu. Arcu tempus, vel
              blandit adipiscing a sed cursus. Augue vestibulum tempus lectus
              gravida condimentum mauris iaculis.
            </p>
            ...
            <blockquote class="flex items-start">
              <svg
                class="w-8 h-8 mt-6 text-gray-300 shrink-0"
            ...
            <p>
              Tempor, risus, congue gravida nulla tincidunt nec diam. Tincidunt
              magnis eu, vitae dictumst commodo dolor in. Aenean dictumst risus
              posuere a at id fermentum nibh. Luctus nunc bibendum duis egestas.
            </p>
          </article>
        </div>
        </div>
