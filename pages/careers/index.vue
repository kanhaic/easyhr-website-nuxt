      ...
      <div class="mx-auto flex max-w-2xl flex-col items-start justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
        <div class="w-full lg:max-w-lg lg:flex-auto">
          ...
          <p class="mt-6 text-xl leading-8 text-gray-600">
            We are always looking for talented individuals to join our team. If you are passionate about technology and want to be part of our journey, we would love to hear from you.
          </p>
        ...
        <div class="w-full lg:max-w-xl lg:flex-auto">
          ...
          <div v-if="!jobOpenings || jobOpenings.length === 0" class="text-center py-12">
            <h3 class="text-lg font-semibold text-gray-900 mb-2">No Current Openings</h3>
            <p class="text-gray-600">
              We don't have any open positions right now, but we're always on the lookout for talent. 
              Feel free to check back later or send us your resume for future opportunities.
            </p>
            <a href="mailto:careers@easyhrworld.com" class="mt-4 inline-block text-sm font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
              Submit your resume <span aria-hidden="true">&rarr;</span>
            </a>
          </div>
          <div v-else>
            <ul class="-my-8 divide-y divide-gray-100">
              <li v-for="opening in jobOpenings" :key="opening.id" class="py-8 border-b border-gray-100">
