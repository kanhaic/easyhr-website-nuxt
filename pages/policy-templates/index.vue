      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="mx-auto mt-5 text-base font-normal leading-7 text-gray-600">
            Policy Templates are a crucial part of any organization's
            documentation. They are used to communicate important information to
            employees, such as policies, procedures, and expectations.
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <div class="mt-6 lg:mt-8">
                <a
                  :href="`/policy-templates/${resource.fields.slug}`"
...
const previousPageUrl = computed(() => {
  ...
  return currentPage.value === 2
    ? "/policy-templates"
    : `/policy-templates/page/${currentPage.value - 1}`;
});

const nextPageUrl = computed(() =>
  isLastPage.value ? "#" : `/policy-templates/page/${currentPage.value + 1}`
);
